...
public class SampleYachtSeedService : ISampleYachtSeedService
{
    ...
    public SampleYachtSeedResult TrySeedSampleYachts()
    {
        ...
        var ownerRoleIds = _context.Roles
            .Where(r => r.Name == Yamore.Model.AppRoles.Owner || r.Name == Yamore.Model.AppRoles.YachtOwner)
            .Select(r => r.RoleId)
            .ToList();
        ...
        using (var transaction = _context.Database.BeginTransaction())
        {
            try
            {
                ...
                yachts = new[]
                {
                    new Yacht { OwnerId = owner.UserId, Name = "Bavaria Cruiser 46", Description = "Comfortable family cruiser.", YearBuilt = 2018, Length = 13.60m, Capacity = 5, Cabins = 3, PricePerDay = 2550, LocationId = cityIds[0], CategoryId = categoryId, StateMachine = Yamore.Model.YachtStateNames.Active, IsActive = true },
                    new Yacht { OwnerId = owner.UserId, Name = "Cheetah Moon", Description = "Luxury motor yacht.", YearBuilt = 2012, Length = 38.36m, Capacity = 15, Cabins = 6, PricePerDay = 25470, LocationId = cityIds[3], CategoryId = categoryId, StateMachine = Yamore.Model.YachtStateNames.Active, IsActive = true },
                    new Yacht { OwnerId = owner.UserId, Name = "Sunseeker SuperHawk", Description = "Sporty motor yacht.", YearBuilt = 2010, Length = 14.80m, Capacity = 6, Cabins = 2, PricePerDay = 7300, LocationId = cityIds[2], CategoryId = categoryId, StateMachine = Yamore.Model.YachtStateNames.Active, IsActive = true },
                    new Yacht { OwnerId = owner.UserId, Name = "Hanse 588", Description = "Modern sailing yacht.", YearBuilt = 2024, Length = 17.02m, Capacity = 8, Cabins = 4, PricePerDay = 12000, LocationId = cityIds[1], CategoryId = categoryId, StateMachine = Yamore.Model.YachtStateNames.Active, IsActive = true },
                };
